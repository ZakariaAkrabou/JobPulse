      ...
      <div className="mx-auto max-w-[1140px] px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-12 items-start">
            ...
            {/* Right: Serif Blockquote with short 1px rule */}
            <div className="md:col-span-8">
              <div className="w-12 h-[1px] bg-[#E5E1D8] mb-6" aria-hidden="true" />
              ...
              <figcaption className="mt-6 font-mono text-xs text-[#6B6B72]">
                <strong className="font-medium text-[#2A2B2F]">Sarah K.</strong> · Frontend engineer, hired at Doctolib through JobMatch
              </figcaption>
            </div>
          </div>
        </ScrollReveal>
