      ...
      <div className="mx-auto max-w-[1140px] px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            {/* H1 Headline with Peach Underline behind italic primary word */}
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-[56px] leading-[1.08] tracking-tight text-[#2A2B2F] text-left">
              ...
              <span className="relative inline-block whitespace-nowrap">
                ...
                {/* Hand-drawn peach underline SVG behind the word */}
                <svg
                  aria-hidden="true"
                  viewBox="0 0 140 18"
                  fill="none"
            ...
            {/* Subhead: 1-2 sentences, max 46ch, plain English, mentions 4 sources */}
              ...
              <div className="flex flex-col sm:flex-row gap-2.5">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className={`w-full h-11 px-3.5 rounded-[8px] bg-white border text-sm text-[#2A2B2F] placeholder:text-[#949499] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3F5D9E] transition-colors ${
          ...
          {/* Right Column (40% ~ 5 cols) Real Product Preview */}
